...
Clone Repository: Lakukan clone pada repositori ini menggunakan perintah 'git clone https://github.com/goATIAN8/Personality-Predictor-main.git'.
Instalasi Library: Jalankan perintah 'pip install -r requirements.txt' pada terminal untuk memasang semua dependensi yang diperlukan.
Jalankan Aplikasi: Gunakan perintah 'streamlit run app.py' melalui terminal dan akses aplikasi melalui alamat http://localhost:8501.
